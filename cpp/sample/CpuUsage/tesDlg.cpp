...
BOOL CTesDlg::OnInitDialog()
{
	...
	pic.SubclassDlgItem(IDC_STATIC, this);
...
void CTesDlg::OnDrawItem(int nIDCtl, LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
...
//DEL int CTesDlg::OnCreate(LPCREATESTRUCT lpCreateStruct) 
//DEL {
//DEL 	if (CDialog::OnCreate(lpCreateStruct) == -1)
//DEL 		return -1;
//DEL 	
//DEL 	// TODO: Add your specialized creation code here
//DEL 	SetTimer(1, 1000, NULL);
//DEL 	return 0;
//DEL }

//DEL void CTesDlg::OnTimer(UINT nIDEvent) 
//DEL {
