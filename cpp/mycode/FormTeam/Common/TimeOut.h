...
//////////////////////////////////////////////////////////////////////
// 超时类，以“秒”为单位
template<int I, bool U=false>
class CTimeOut_
{
public:
	CTimeOut_(int nIntervalSecs=I, bool bUpdate=U) { m_nInterval = nIntervalSecs; if(bUpdate) m_tUpdateTime = (clock()/1000); else m_tUpdateTime = 0; }
//	virtual ~CTimeOut_() {}
...
public: // get
	...
	clock_t	GetLastUpdate()						{ return m_tUpdateTime; }
	int		GetElapse()							{ return m_tUpdateTime ? ::CutRange(((clock()/1000)-(int)m_tUpdateTime), 0, m_nInterval) : 0; }
...
{
public:
	CTimeOutMS_(int nIntervalSecs=I, bool bUpdate=U) { m_nInterval = nIntervalSecs; if(bUpdate) m_tUpdateTime = clock(); else m_tUpdateTime = 0; }
//	virtual ~CTimeOutMS_() {}
...
public:
	...
	bool	ToNextTime	()						{ if(IsTimeOut()) return Update(),true; else return false; }
	bool	ToNextInterval()					{ if(IsTimeOut()) return m_tUpdateTime+=m_nInterval,true; else return false; }
...
public: // get
	...
	int		GetInterval()						{ return m_nInterval; }
	clock_t	GetLastUpdate()						{ return m_tUpdateTime; }
	int		GetElapse()							{ return m_tUpdateTime ? ::CutRange((clock()-(int)m_tUpdateTime), 0, m_nInterval) : 0; }
